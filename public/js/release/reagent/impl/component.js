...
if((i < len)){
var k = (ks[i]);
var G__25762 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__25763 = (i + (1));
m = G__25762;
i = G__25763;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__25764 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__25764);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__25766 = c;
var G__25766__$1 = (((G__25766 == null))?null:G__25766.prototype);
if((G__25766__$1 == null)){
return null;
} else {
return G__25766__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__25768 = c;
var G__25768__$1 = (((G__25768 == null))?null:G__25768.prototype);
if((G__25768__$1 == null)){
return null;
} else {
return G__25768__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__25772__delegate = function (args){
var G__25770 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__25770) : reagent.impl.component.as_element.call(null,G__25770));
};
...
while (G__25773__i < G__25773__a.length) {G__25773__a[G__25773__i] = arguments[G__25773__i + 0]; ++G__25773__i;}
  args = new cljs.core.IndexedSeq(G__25773__a,0,null);
} 
return G__25772__delegate.call(this,args);};
G__25772.cljs$lang$maxFixedArity = 0;
G__25772.cljs$lang$applyTo = (function (arglist__25774){
var args = cljs.core.seq(arglist__25774);
return G__25772__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__25776 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__25777 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__25777);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__25776);
}});
...
var c = this;
var G__25781_25783 = goog.object.get(c,"cljsRatom");
if((G__25781_25783 == null)){
} else {
reagent.ratom.dispose_BANG_(G__25781_25783);
}
...
var renders_25784 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_25785 = cljs.core.first(cljs.core.vals(renders_25784));
...
if((cljs.core.count(renders_25784) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_25784))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_25785)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_25785], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__25786 = o;
goog.object.set(G__25786,cljs.core.name(k),v);
...
var name = (function (){var G__25787 = fiber;
var G__25787__$1 = (((G__25787 == null))?null:G__25787.type);
if((G__25787__$1 == null)){
return null;
} else {
return G__25787__$1.displayName;
}
})();
var parent = (function (){var G__25788 = fiber;
if((G__25788 == null)){
return null;
} else {
return G__25788.return;
}
})();
var path = (function (){var G__25789 = parent;
var G__25789__$1 = (((G__25789 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__25789) : reagent.impl.component.fiber_component_path.call(null,G__25789)));
if((G__25789__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25789__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__25791 = c;
if((G__25791 == null)){
return null;
} else {
return goog.object.get(G__25791,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__25792._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__25794 = c;
if((G__25794 == null)){
return null;
} else {
return goog.object.get(G__25794,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__25796 = c;
if((G__25796 == null)){
return null;
} else {
return G__25796._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__25798 = instance;
if((G__25798 == null)){
return null;
} else {
return goog.object.get(G__25798,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__25799 = instance;
if((G__25799 == null)){
return null;
} else {
return G__25799._currentElement;
}
}
})();
var name = (function (){var G__25800 = elem;
var G__25800__$1 = (((G__25800 == null))?null:G__25800.type);
if((G__25800__$1 == null)){
return null;
} else {
return G__25800__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__25802 = elem;
if((G__25802 == null)){
return null;
} else {
return goog.object.get(G__25802,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__25803._owner;
}
}
})();
var path = (function (){var G__25804 = owner;
var G__25804__$1 = (((G__25804 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__25804) : reagent.impl.component.component_path.call(null,G__25804)));
if((G__25804__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25804__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__25805 = c;
var G__25805__$1 = (((G__25805 == null))?null:G__25805.constructor);
if((G__25805__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__25805__$1);
}
}
})();
