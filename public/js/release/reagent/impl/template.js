...
var G__25825 = o;
goog.object.set(G__25825,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__25829 = o;
goog.object.set(G__25829,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__25830__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__25831__i < G__25831__a.length) {G__25831__a[G__25831__i] = arguments[G__25831__i + 0]; ++G__25831__i;}
  args = new cljs.core.IndexedSeq(G__25831__a,0,null);
} 
return G__25830__delegate.call(this,args);};
G__25830.cljs$lang$maxFixedArity = 0;
G__25830.cljs$lang$applyTo = (function (arglist__25832){
var args = cljs.core.seq(arglist__25832);
return G__25830__delegate(args);
});
...
var G__25833 = props;
var G__25833__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25833,cljs.core.cst$kw$id,id):G__25833);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25833__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__25833__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__25834 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25834,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__25834;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25835){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25836__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__25838_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__25838_SHARP_);
}));
} else {
return null;
}
...
var vec__25841 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25841,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25841,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25841,(2),null);
...
var temp__5739__auto___25845 = reagent.impl.template.key_from_vec(v);
...
var temp__5739__auto___25847 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___25847 == null)){
} else {
var key_25848 = temp__5739__auto___25847;
(jsprops.key = key_25848);
}
...
var G__25849 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__25849) : reagent.impl.template.as_element.call(null,G__25849));
} else {
var temp__5739__auto___25850 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___25850 == null)){
} else {
var key_25851 = temp__5739__auto___25850;
(jsprops.key = key_25851);
}
...
var G__25853 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__25853)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__25853)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25854){
...
var ctx = ({});
var vec__25863 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25863,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25863,(1),null);
...
var G__25866 = (cljs.core.count(argv) - first_child);
switch (G__25866) {
case (0):
...
break;
case (1):
var G__25867 = component;
var G__25868 = jsprops;
var G__25869 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__25867,G__25868,G__25869);
